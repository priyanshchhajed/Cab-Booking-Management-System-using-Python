...
class user:
    ...
    def login(self):
        ...
        if result:
            ...
            self.logf.pack_forget()
            self.head['text'] = "Cab Booking Management System"
...
class travel:
    ...
    def __init__(self, root):
        ...
        Tops = Frame(MainFrame, bd=20, bg="yellow")  # width=1350,
        Tops.pack(fill=X)

        self.lblTitle = Label(Tops, font=('arial', 30, 'bold'), text="TRAVEL WITH EASE", foreground="black",
                              bg="yellow", )
        self.lbldate = Label(Tops, font=('arial', 20, 'bold'), text=DateofOrder.get(), foreground="black", bg="yellow")
        '''img = PhotoImage(file=r"D:\taxi.png")
        # img = img.resize((250, 250), Image.ANTIALIAS)
        imglabel = Label(Tops, image=img)
        imglabel.grid(row=0, column=0)
        img=Image.open("cab.png")
        photo=ImageTk.PhotoImage(img)
        imglabel = Label(Tops, image=photo)
        imglabel.grid(row=0, column=0)'''
        ...
        # ============================================================================================================
        CustomerDetailsFrame = LabelFrame(MainFrame, width=1350, height=500, pady=5, bg="white")
    ...
    #=================================================================================================================
        ...
        self.chkStandard = Radiobutton(Book_Frame, text="Bike", value=1, variable=carType, font=('arial', 14, 'bold'),
        ...
        self.chkPrimeSedand = Radiobutton(Book_Frame, text="Auto", value=2, variable=carType,
        ...
        self.chkPremiumSedan = Radiobutton(Book_Frame, text="Car", value=3, variable=carType,
